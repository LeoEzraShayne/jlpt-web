...
const copy = {
  zh: {
    ...
    requestTitle: "如何申请",
    steps: [
      "请使用注册该服务时的 Google 邮箱发送申请，并注明申请范围：日语学习服务、旧功过格服务，或两者。",
    ...
    scope: [
      ...
      "为必要的账务核对、安全、争议处理或适用要求，部分交易记录可能需要保留。请在申请中询问具体删除范围及需要保留的数据；本页不承诺立即清除所有副本或固定完成时间。",
    ],
    noticeTitle: "发送申请后",
    notices: [
      "申请需要人工核验与处理。发送邮件不代表账号已经删除，本页也不会执行删除或显示处理结果。",
  ...
  en: {
    ...
    steps: [
      "Send your request from the Google email address registered with the service. Specify JLPT Sentence Lab, legacy Merit Ledger, or both.",
    ...
    scope: [
      ...
      "Some transaction records may need to be retained for necessary accounting, security, dispute handling, or applicable requirements. Ask about the specific deletion scope and any retained data in your request. This page does not promise immediate removal of all copies or a fixed completion time.",
    ],
    noticeTitle: "After sending your request",
    notices: [
      "Requests require manual verification and processing. Sending an email does not mean your account has been deleted. This page does not perform deletion or display a processing result.",
